...
if [ "$1" = "chromebook_snow" ] && [ "$2" = "armv7l" ]; then
...
if [ "$1" = "chromebook_veyron" ] && [ "$2" = "armv7l" ]; then
...
if [ "$1" = "chromebook_nyan" ] && [ "$2" = "armv7l" ]; then
...
if [ "$1" = "allwinner_h3" ] && [ "$2" = "armv7l" ]; then
...
if [ "$1" = "orbsmart_s92_beelink_r89" ] && [ "$2" = "armv7l" ]; then
...
if [ "$1" = "rockchip_rk322x" ] && [ "$2" = "armv7l" ]; then
...
if [ "$1" = "rockchip_rk3288" ] && [ "$2" = "armv7l" ]; then
...
if [ "$1" = "raspberry_pi_2" ] && [ "$2" = "armv7l" ]; then
...
if [ "$1" = "raspberry_pi_3" ] && [ "$2" = "aarch64" ]; then
...
if [ "$1" = "raspberry_pi_4" ] && [ "$2" = "aarch64" ]; then
...
if [ "$1" = "amlogic_gx" ] && [ "$2" = "aarch64" ]; then
...
if [ "$1" = "allwinner_h6" ] && [ "$2" = "aarch64" ]; then
...
if [ "$1" = "rockchip_rk33xx" ] && [ "$2" = "aarch64" ]; then
