...
if [ "$1" = "all" ] || [ "$1" = "chromebook_snow" ]; then
  ...
  wget -nv https://github.com/hexdump0815/linux-mainline-and-mali-on-samsung-snow-chromebook/raw/master/misc.cbe/boot/boot-chromeboot_snow-armv7l.dd -O boot/boot-chromebook_snow-armv7l.dd
  rm -f files/gl4es-armv7l-debian.tar.gz
  wget -nv https://github.com/hexdump0815/linux-mainline-and-mali-on-samsung-chromebook-snow/raw/master/misc.cbe/gl4es-armv7l-debian.tar.gz -O files/gl4es-armv7l-debian.tar.gz
  rm -f files/gl4es-armv7l-ubuntu.tar.gz
  wget -nv https://github.com/hexdump0815/linux-mainline-and-mali-on-samsung-chromebook-snow/raw/master/misc.cbe/gl4es-armv7l-ubuntu.tar.gz -O files/gl4es-armv7l-ubuntu.tar.gz
  rm -f files/xorg-armsoc-armv7l-debian.tar.gz
  wget -nv https://github.com/hexdump0815/linux-mainline-and-mali-on-samsung-chromebook-snow/raw/master/misc.cbe/xorg-armsoc-armv7l-debian.tar.gz -O files/xorg-armsoc-armv7l-debian.tar.gz
  rm -f files/xorg-armsoc-armv7l-ubuntu.tar.gz
  wget -nv https://github.com/hexdump0815/linux-mainline-and-mali-on-samsung-chromebook-snow/raw/master/misc.cbe/xorg-armsoc-armv7l-ubuntu.tar.gz -O files/xorg-armsoc-armv7l-ubuntu.tar.gz
  rm -f files/opengl-chromebook_snow-armv7l.tar.gz
  wget -nv https://github.com/hexdump0815/linux-mainline-and-mali-on-samsung-chromebook-snow/raw/master/misc.cbe/opt-mali-exynos5250.tar.gz -O files/opengl-chromebook_snow-armv7l.tar.gz
  rm -f files/opengl-fbdev-chromebook_snow-armv7l.tar.gz
  wget -nv https://github.com/hexdump0815/linux-mainline-and-mali-on-samsung-chromebook-snow/raw/master/misc.cbe/opt-mali-exynos5250-fbdev-r5p0.tar.gz -O files/opengl-fbdev-chromebook_snow-armv7l.tar.gz
fi
