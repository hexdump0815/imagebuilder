...
mkdir /opt/wayfire-aarch64/sample-config
wget -v https://github.com/hexdump0815/wayfire-arm-build/releases/download/0.6.0.0/wayfire.ini -O /opt/wayfire-aarch64/sample-config/wayfire.ini
wget -v https://github.com/hexdump0815/wayfire-arm-build/releases/download/0.6.0.0/wf-shell.ini -O /opt/wayfire-aarch64/sample-config/wf-shell.ini
