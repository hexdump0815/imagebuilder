...
wget -v https://github.com/hexdump0815/linux-rockchip-rk3588-kernel/raw/${rockchip_rk3588_u_boot_binary_version}/misc.r58/u-boot/boot-orange-pi-5.dd.gz -O - | gunzip -c > ${DOWNLOAD_DIR}/boot-rockchip_rk3588-${2}.dd
...
wget -v https://github.com/hexdump0815/linux-rockchip-rk3588-kernel/raw/${rockchip_rk3588_u_boot_binary_version}/misc.r58/u-boot/boot-rock-5b.dd.gz -O - | gunzip -c > ${DOWNLOAD_DIR}/boot-extra-${1}/boot-rock-5b.dd
