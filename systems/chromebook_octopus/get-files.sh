...
chromebook_coral_release_version="5.18.0-stb-cbc%2B"
...
# put some alternative kernels to /boot/extra
rm -rf ${DOWNLOAD_DIR}/boot-extra-${1}
mkdir -p ${DOWNLOAD_DIR}/boot-extra-${1}
wget -v https://github.com/hexdump0815/linux-mainline-x86-64-kernel/releases/download/${chromebook_coral_release_version}/${chromebook_coral_release_version}.tar.gz -O ${DOWNLOAD_DIR}/boot-extra-${1}/kernel-chromebook_coral-${2}.tar.gz
