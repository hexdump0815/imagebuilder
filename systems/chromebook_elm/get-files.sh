...
( cd ${DOWNLOAD_DIR} ; tar xzf kernel-chromebook_elm-aarch64.tar.gz boot/vmlinux.kpart-elm-${chromebook_elm_release_version} ; mv boot/vmlinux.kpart-elm-${chromebook_elm_release_version} boot-chromebook_elm-aarch64.dd ; rmdir boot )
