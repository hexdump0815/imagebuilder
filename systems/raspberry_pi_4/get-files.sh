...
raspberry_pi_4_release_version="6.12.12-stb-rpi%2B"
...
wget -v https://github.com/hexdump0815/linux-mainline-raspberry-pi-kernel/releases/download/${raspberry_pi_4_release_version}/${raspberry_pi_4_release_version}.tar.gz -O ${DOWNLOAD_DIR}/kernel-raspberry_pi_4-${2}.tar.gz

# get u-boot.bin
rm -rf ${DOWNLOAD_DIR}/postinstall-${1}
mkdir -p ${DOWNLOAD_DIR}/postinstall-${1}
wget -v https://github.com/hexdump0815/u-boot-misc/releases/download/${raspberry_pi_4_uboot_version}/u-boot.bin-rpi4b.gz -O - | gunzip -c > ${DOWNLOAD_DIR}/postinstall-${1}/u-boot.bin-rpi4b
wget -v https://github.com/hexdump0815/u-boot-misc/releases/download/${raspberry_pi_4_uboot_version}/u-boot.bin-rpi3bplus.gz -O - | gunzip -c > ${DOWNLOAD_DIR}/postinstall-${1}/u-boot.bin-rpi3bplus
wget -v https://github.com/hexdump0815/u-boot-misc/releases/download/${raspberry_pi_4_uboot_version}/u-boot.bin-rpi3b.gz -O - | gunzip -c > ${DOWNLOAD_DIR}/postinstall-${1}/u-boot.bin-rpi3b
