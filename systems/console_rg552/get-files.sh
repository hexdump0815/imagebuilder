...
wget -v https://github.com/thenameisluk/linux-rk3xxx-kernel/releases/download/6.12.0-stb-rg552%2B/6.12.0-stb-rg552+.tar.gz -O ${DOWNLOAD_DIR}/kernel-console_rg552-${2}.tar.gz