...
# get different u-boot versions for different exynos5250 chromebook versions and the legacy chromeos kernel to have them around
...
wget -v https://github.com/hexdump0815/linux-chromeos-kernel/releases/download/${chromebook_snow_legacy_release_version}/${chromebook_snow_legacy_release_version}.tar.gz -O ${DOWNLOAD_DIR}/boot-extra-${1}/kernel-chromebook_snow-armv7l-legacy.tar.gz
