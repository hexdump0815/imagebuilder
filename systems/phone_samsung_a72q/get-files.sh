...
rm -f ${DOWNLOAD_DIR}/kernel-samsung_a72q-${2}.tar.gz
wget -v https://github.com/hexdump0815/linux-mainline-qcom-msm8998-kernel/releases/download/${samsung_a72q_release_version}/${samsung_a72q_release_version}.tar.gz -O ${DOWNLOAD_DIR}/kernel-samsung_a72q-${2}.tar.gz
