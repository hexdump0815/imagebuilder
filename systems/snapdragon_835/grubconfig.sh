...
sed -i 's/GRUB_CMDLINE_LINUX=""/GRUB_CMDLINE_LINUX="rootwait ro console=tty0 fsck.repair=yes net.ifnames=0 ipv6.disable=1 noresume apparmor=0 module_blacklist=evbug efi=novamap clk_ignore_unused pd_ignore_unused deferred_probe_timeout=30"/g' /etc/default/grub
