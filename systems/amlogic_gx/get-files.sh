...
wget -v https://github.com/hexdump0815/u-boot-misc/releases/download/${amlogic_gx_gxb_serial_uboot_version}/gxb-u-boot.bin-serial.gz -O - | gunzip -c > ${DOWNLOAD_DIR}/boot-extra/gxb-serial-tv-box-u-boot.bin
wget -v https://github.com/hexdump0815/u-boot-misc/releases/download/${amlogic_gx_gxl_uboot_version}/boot-amlogic_gxl_atf-aarch64-a95x-r2.dd.gz -O - | gunzip -c > ${DOWNLOAD_DIR}/boot-extra/boot-amlogic_gxl_atf-aarch64-tv-box.dd
