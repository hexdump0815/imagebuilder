...
( cd ${DOWNLOAD_DIR} ; tar xzf kernel-chromebook_oak-${2}.tar.gz boot ; mv boot/vmlinux.kpart-elm-* boot-chromebook_oak-${2}.dd ; rm -rf boot )
#( cd ${DOWNLOAD_DIR} ; tar xzf kernel-chromebook_oak-${2}.tar.gz boot ; mv boot/vmlinux.kpart-oak-* boot-chromebook_oak-${2}.dd ; rm -rf boot )
